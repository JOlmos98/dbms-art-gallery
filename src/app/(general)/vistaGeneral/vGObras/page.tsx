            ...
            <div className="flex flex-col row-start-2 items-start sm:items-start">
                <div>
                    ...
                    <p className="text-lg mb-5">
                        La tabla <span className="font-bold text-sidebar-accent">Obras</span> contiene información sobre las obras de arte, incluyendo título, tipo, precio, descripción, fecha de creación, estado y el artista que la creó.
                    </p>
                </div>
